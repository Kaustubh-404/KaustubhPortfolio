    ...
    <div className="min-h-screen bg-[#f8fafc] font-mono relative overflow-x-hidden">
      ...
      <section id="home" className="pt-32 pb-20 px-4 relative">
        <div className="max-w-6xl mx-auto text-center relative">
          {/* Floating Elements */}
          {/* Additional Floating Elements - Add these to your hero section */}
          <div className="absolute top-40 left-1/4 animate-float">
            <div className="w-14 h-14 bg-gradient-to-br from-[#334155] to-[#64748b] rounded-2xl border-4 border-[#e2e8f0] flex items-center justify-center text-xl -rotate-12">
              💻
            </div>
          </div>

          <div className="absolute top-60 right-1/4 animate-float-delayed">
            <div className="w-10 h-10 bg-gradient-to-br from-[#64748b] to-[#334155] rounded-full border-4 border-[#e2e8f0] flex items-center justify-center text-sm rotate-45">
              💡
            </div>
          </div>

          <div className="absolute -top-5 right-1/3 animate-float">
            <div className="w-12 h-12 bg-gradient-to-br from-[#475569] to-[#334155] rounded-2xl border-4 border-[#e2e8f0] flex items-center justify-center text-lg rotate-6">
              🔧
            </div>
          </div>

          <div className="absolute top-32 left-1/2 animate-float-delayed">
            <div className="w-8 h-8 bg-gradient-to-br from-[#64748b] to-[#475569] rounded-full border-4 border-[#e2e8f0] flex items-center justify-center text-xs -rotate-30">
              🎯
            </div>
          </div>

          <div className="absolute top-80 left-16 animate-float">
            <div className="w-16 h-16 bg-gradient-to-br from-[#334155] to-[#475569] rounded-2xl border-4 border-[#e2e8f0] flex items-center justify-center text-2xl rotate-15">
              🌟
            </div>
          </div>

          <div className="absolute top-96 right-20 animate-float-delayed">
            <div className="w-10 h-10 bg-gradient-to-br from-[#64748b] to-[#334155] rounded-full border-4 border-[#e2e8f0] flex items-center justify-center text-sm -rotate-20">
              🔥
            </div>
          </div>

          <div className="absolute top-52 right-32 animate-float">
            <div className="w-12 h-12 bg-gradient-to-br from-[#475569] to-[#64748b] rounded-2xl border-4 border-[#e2e8f0] flex items-center justify-center text-lg rotate-25">
              ⚙️
            </div>
          </div>

          <div className="absolute top-24 left-32 animate-float-delayed">
            <div className="w-14 h-14 bg-gradient-to-br from-[#334155] to-[#64748b] rounded-full border-4 border-[#e2e8f0] flex items-center justify-center text-xl -rotate-10">
              🚀
            </div>
          </div>
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="bg-gradient-to-r from-[#475569] to-[#64748b] bg-clip-text text-transparent font-black text-sm mb-2">
      ...
      <footer className="bg-[#1e293b] text-white py-12 px-4 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="border-t border-gray-600 pt-6">
            <p className="text-[#94a3b8] mb-2">© 2025 Kaustubh Pardeshi. All rights reserved.</p>
